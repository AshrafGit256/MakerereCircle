...
0776416817
    ...
    <ul class="space-y-4 mt-2">
        ...
        <li><a wire:navigate href="{{route('course-enrollment')}}" class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)" class=" text-lg  {{request()->routeIs('course-enrollment')?'font-bold':'font-medium'}}">Enroll</h4>
            </a></li>

        <li><a wire:navigate href="{{route('notifications')}}" class="flex items-center gap-5">

                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.9"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M15 17h5l-5 5v-5zM4.868 12.683A17.925 17.925 0 0112 21c7.962 0 12-1.21 12-2.683m-12 2.683a17.925 17.925 0 01-7.132-8.317M12 21c4.411 0 8-4.03 8-9s-3.589-9-8-9-8 4.03-8 9a9.06 9.06 0 001.832 5.445L4 21l4.868-8.317z" />
                    </svg>
                </span>

                <h4 x-cloak x-show="!(shrink||drawer)" class=" text-lg  {{request()->routeIs('notifications')?'font-bold':'font-medium'}}">Notifications</h4>
            </a></li>
        ...
        <li>
            <a wire:navigate href="{{route('profile.home',auth()->user()->username)}}" class="flex items-center gap-5">
                <x-avatar src="{{ auth()->user()->getImage() }}" class=" w-9 h-9 shrink-0" />
                <h4 x-cloak x-show="!(shrink||drawer)"
...
<nav class="fixed bottom-0 inset-x-0 z-50 md:hidden bg-base-100 border-t shadow-lg">
    <ul class="grid grid-cols-5 text-xs text-gray-600">
        ...
        <li>
            <a href="{{ route('classes') }}" class="flex flex-col items-center py-2 {{ request()->routeIs('classes') ? 'text-green-600' : 'text-gray-600' }}">
        ...
        <li>
            <a href="{{ route('course-enrollment') }}" class="flex flex-col items-center py-2 {{ request()->routeIs('course-enrollment') ? 'text-green-600' : 'text-gray-600' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.9" stroke="currentColor" class="w-6 h-6">
        ...
        <li>
            <a href="{{ route('notifications') }}" class="flex flex-col items-center py-2 {{ request()->routeIs('notifications') ? 'text-green-600' : 'text-gray-600' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.9" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-5 5v-5zM4.868 12.683A17.925 17.925 0 0112 21c7.962 0 12-1.21 12-2.683m-12 2.683a17.925 17.925 0 01-7.132-8.317M12 21c4.411 0 8-4.03 8-9s-3.589-9-8-9-8 4.03-8 9a9.06 9.06 0 001.832 5.445L4 21l4.868-8.317z" />
                </svg>
