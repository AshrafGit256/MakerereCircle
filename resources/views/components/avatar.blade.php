...
<div
    {{$attributes->merge([
        'class'=>"shrink-0 inline-flex items-center justify-center 
                  ...
                  ->class($story ? 'bg-gradient-to-r p-[2px] ring-2 ring-white from-green-200 via-blue-200 to-green-300 rounded-full' : ' ')
                  }}>
    ...
    @if (!$src)
    <svg
        class="shrink-0 w-full h-full rounded-full text-gray-300 bg-gray-100 dark:bg-gray-600"
        fill="currentColor"
        viewBox="0 0 24 24">
