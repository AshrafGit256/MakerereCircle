...
<div class="max-w-3xl mx-auto">
    ...
    <section class="grid grid-cols-12 p-2 my-5 lg:my-12 ">
        ...
        <aside class="col-span-8 lg:max-w-2xl lg:mx-auto flex flex-col gap-5">
            ...
            <section class="grid grid-cols-12 gap-3">
                ...
                <div class="col-span-12 lg:col-span-6 grid grid-cols-2 gap-3 ">
                    ...
                    <a href="{{ route('profile.edit') }}" type="button"
                        class=" inline-flex justify-center font-bold items-center  rounded-lg  text-sm p-1.5 px-2 transition  bg-transparent hover:bg-transparent-100 ">
                        Edit profile
                    </a>
            ...
            @if($user->location || $user->education_level)
    ...
    <section class="border-t">
        <ul class="grid grid-cols-3 gap-4 max-w-sm mx-auto pb-3 ">
            ...
            <!-- Profile Details Tab -->
            <li class="flex items-center gap-2 py-2 cursor-pointer {{request()->routeIs('profile.details')?'border-t border-black':''}}">
                <a wire:navigate class="flex items-center gap-2 py-2 cursor-pointer"
                    href="{{route('profile.details', $user->username)}}">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </span>
                    <h4 class="font-bold capitalize">Details</h4>
                </a>
            </li>
        </ul>
