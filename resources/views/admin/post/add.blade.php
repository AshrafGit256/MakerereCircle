                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="description" value="{{ old('description') }}" class="form-control" required placeholder="Description"></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="allow_commenting">
                                </div>

                                <div class="form-group">
                                    <label style="display: block;">Allow View like Count<span style="color: red;"></span></label>
                                    <input type="checkbox" name="hide_like_view">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="found">
                                </div>
